...
const IC_CALENDAR = `<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M8 2V6M16 2V6M3 10H21M5 4H19C20.1046 4 21 4.89543 21 6V20C21 21.1046 20.1046 22 19 22H5C3.89543 22 3 21.1046 3 20V6C3 4.89543 3.89543 4 5 4Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><rect x="7" y="14" width="2" height="2" rx="0.5" fill="currentColor"/><rect x="11" y="14" width="2" height="2" rx="0.5" fill="currentColor"/><rect x="15" y="14" width="2" height="2" rx="0.5" fill="currentColor"/></svg>`
...
function renderPlantDetail(plant) {
  ...
  if (plant.next_repotting_date) {
    ...
    const entry = createElement('div', 'history-item repotting-unplanned')
    const iconEl = createElement('span', 'history-item-icon')
    iconEl.innerHTML = IC_POT
    ...
    calBtn.addEventListener('click', openEditPlantForm)
...
function openFullRepotting(plantId) {
  ...
  if (plant.next_repotting_date) {
    ...
    const calBtn = createElement('button', 'repotting-calendar-btn')
    calBtn.innerHTML = IC_CALENDAR
    calBtn.addEventListener('click', () => { closeOverlay('overlay-repotting'); openEditPlantForm() })
    entry.append(iconEl, label, calBtn)
    container.appendChild(entry)
  }
